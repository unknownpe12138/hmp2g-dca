...
try:
    ...
    print("Warning: paramiko not available, remote upload disabled")
...
# Only define SFTP classes if paramiko is available
if PARAMIKO_AVAILABLE:
    ...
    def get_ssh_sftp(addr, usr, pwd):
        raise NotImplementedError("paramiko not available")
